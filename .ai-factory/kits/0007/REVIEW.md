당신은 패킷 0007 ("S0 차단 화면 Blocking")의 코드 리뷰를 수행합니다.
...
## 테스트 파일
src/__tests__/packet-0007.test.ts
...
- .ai-factory/spec.md
- src/pages/Blocking.tsx
- src/__tests__/packet-0007.test.ts (존재하는 경우)
...
### Agent 2: 조용한 실패 탐지기
각 파일을 읽으세요: src/pages/Blocking.tsx
...
```
════════════════════════════════════════════════
🔍 코드 리뷰 리포트: 0007 — S0 차단 화면 Blocking
════════════════════════════════════════════════

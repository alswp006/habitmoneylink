당신은 패킷 0006 ("공용 UI 컴포넌트: 습관 행(HabitListRow)")의 코드 리뷰를 수행합니다.
...
- .ai-factory/spec.md
- src/components/HabitListRow.tsx
- src/__tests__/packet-0006.test.ts (존재하는 경우)
...
### Agent 2: 조용한 실패 탐지기
각 파일을 읽으세요: src/components/HabitListRow.tsx
...
```
════════════════════════════════════════════════
🔍 코드 리뷰 리포트: 0006 — 공용 UI 컴포넌트: 습관 행(HabitListRow)
════════════════════════════════════════════════

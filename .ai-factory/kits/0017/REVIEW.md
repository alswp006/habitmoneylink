당신은 패킷 0017 ("라우팅 와이어링 + Provider 연결 + 통합 폴리시")의 코드 리뷰를 수행합니다.
...
## 테스트 파일
src/__tests__/packet-0017.test.ts
...
- .ai-factory/spec.md
- src/App.tsx
- src/__tests__/packet-0017.test.ts (존재하는 경우)
...
```
════════════════════════════════════════════════
🔍 코드 리뷰 리포트: 0017 — 라우팅 와이어링 + Provider 연결 + 통합 폴리시
════════════════════════════════════════════════

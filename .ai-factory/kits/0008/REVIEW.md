당신은 패킷 0008 ("S1 홈 / (로딩/빈상태/에러다이얼로그/체크인/요약/배너)")의 코드 리뷰를 수행합니다.
...
- .ai-factory/spec.md
- src/pages/Home.tsx
- src/__tests__/packet-0008.test.ts (존재하는 경우)
...
```
════════════════════════════════════════════════
🔍 코드 리뷰 리포트: 0008 — S1 홈 / (로딩/빈상태/에러다이얼로그/체크인/요약/배너)
════════════════════════════════════════════════

당신은 패킷 0013 ("S6 배지 보관함 /badge (배지 리스트)")의 코드 리뷰를 수행합니다.
...
## 테스트 파일
src/__tests__/packet-0013.test.ts
...
- .ai-factory/spec.md
- src/pages/Badge.tsx
- src/__tests__/packet-0013.test.ts (존재하는 경우)
...
### Agent 2: 조용한 실패 탐지기
각 파일을 읽으세요: src/pages/Badge.tsx
...
```
════════════════════════════════════════════════
🔍 코드 리뷰 리포트: 0013 — S6 배지 보관함 /badge (배지 리스트)
════════════════════════════════════════════════

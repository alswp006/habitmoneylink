당신은 패킷 0002 ("localStorage base IO 유틸 + 키 상수")의 코드 리뷰를 수행합니다.
...
## 테스트 파일
src/__tests__/packet-0002.test.ts
...
- src/lib/storage/keys.ts
- src/lib/storage/base.ts
- src/__tests__/packet-0002.test.ts (존재하는 경우)
...
### Agent 2: 조용한 실패 탐지기
각 파일을 읽으세요: src/lib/storage/keys.ts
src/lib/storage/base.ts
...
```
════════════════════════════════════════════════
🔍 코드 리뷰 리포트: 0002 — localStorage base IO 유틸 + 키 상수
════════════════════════════════════════════════

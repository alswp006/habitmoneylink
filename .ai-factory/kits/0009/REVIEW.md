당신은 패킷 0009 ("S2 습관 생성 /habit/new (카테고리 시트 + 입력 + 저장)")의 코드 리뷰를 수행합니다.
...
## 테스트 파일
src/__tests__/packet-0009.test.ts
...
- .ai-factory/spec.md
- src/pages/HabitNew.tsx
- src/__tests__/packet-0009.test.ts (존재하는 경우)
...
### Agent 2: 조용한 실패 탐지기
각 파일을 읽으세요: src/pages/HabitNew.tsx
...
```
════════════════════════════════════════════════
🔍 코드 리뷰 리포트: 0009 — S2 습관 생성 /habit/new (카테고리 시트 + 입력 + 저장)
════════════════════════════════════════════════

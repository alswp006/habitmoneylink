당신은 패킷 0005 ("공용 UI 컴포넌트: 요약 카드(HeroSummaryCard)")의 코드 리뷰를 수행합니다.
...
## 테스트 파일
src/__tests__/packet-0005.test.ts
...
- .ai-factory/spec.md
- src/components/HeroSummaryCard.tsx
- src/__tests__/packet-0005.test.ts (존재하는 경우)
...
### Agent 2: 조용한 실패 탐지기
각 파일을 읽으세요: src/components/HeroSummaryCard.tsx
...
```
════════════════════════════════════════════════
🔍 코드 리뷰 리포트: 0005 — 공용 UI 컴포넌트: 요약 카드(HeroSummaryCard)
════════════════════════════════════════════════

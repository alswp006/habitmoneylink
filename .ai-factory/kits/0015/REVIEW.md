당신은 패킷 0015 ("Integration 1/2: App.tsx 라우팅 연결 + 세션/실행환경 가드(401)")의 코드 리뷰를 수행합니다.
...
## 테스트 파일
src/__tests__/packet-0015.test.ts
...
- .ai-factory/spec.md
- src/App.tsx
- src/__tests__/packet-0015.test.ts (존재하는 경우)
...
```
════════════════════════════════════════════════
🔍 코드 리뷰 리포트: 0015 — Integration 1/2: App.tsx 라우팅 연결 + 세션/실행환경 가드(401)
════════════════════════════════════════════════
